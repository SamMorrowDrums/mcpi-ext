...
1. `annotations.readOnlyHint === true` — can't modify anything
2. `outputSchema` is defined — results are machine-parseable

The extension checks these at startup and only exposes eligible tools to the sandbox.
